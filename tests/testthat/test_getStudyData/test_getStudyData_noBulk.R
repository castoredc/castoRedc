...
complete_study_output <- castor_api$getStudyData(creds$output_study, bulk=FALSE)

test_that("getStudyData returns the expected study data when not using bulk.", {
  actual <- complete_study_output$Study
  expected <- read.csv("../../test_files/files_output/CastorStudy.csv", check.names=F)
  expect_identical(actual, expected)
})

test_that("getStudyData returns the expected data for the repeated measure Unscheduled Visit when not using bulk", {
...
test_that("getStudyData returns the expected data for the repeated measure Medication when not using bulk", {
...
test_that("getStudyData returns the expected data for the repeated measure Comorbidities when not using bulk", {
  actual <- complete_study_output$`Repeating data`$Comorbidities
  expected <- read.csv("../../test_files/files_output/CastorUnscheduledVisit.csv", check.names=F)
  expect_identical(actual, expected)
})

test_that("getStudyData returns the expected data for the repeated measure Adverse Events when not using bulk", {
...
test_that("getStudyData returns the expected data for the survey Quality of Life when not using bulk", {
